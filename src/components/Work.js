			...
			<section className="section--work">
				<div className="container--welcome">
					...
					<ul className="list--projects">
						<ProjectBox project__name="Twitter" project__heading="Beach Twitter" project__site="" project__description="A beachy version of Twitter using React, Redux, Reselect, and Normalizr to optimize efficiency."/>

						<ProjectBox project__name="Haiku" project__heading="Haiku For You" project__site="" project__description="A React and Redux front end combined with a Rails API backend to create a site for poetry enthusiasts."/>
