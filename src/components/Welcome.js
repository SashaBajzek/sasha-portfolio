      ...
      <section className="section--welcome">
        <div className="container--welcome">
          ...
          <p className="welcome--text">
            My name is Sasha Bajzek and I am a front-end web developer with a
            structural engineering background who loves building great websites,
            creatively solving problems, and learning new skills every day.
          </p>
          <p className="welcome--text">
            My favorite libraries to work with at the moment are React and
            Redux, and I get excited about making websites accessible,
