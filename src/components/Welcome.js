		...
		return (
			<section className="section--welcome">
				<div className="container--welcome">
					...
					<p className="welcome--text">While structural engineering has been rewarding, I am breaking into the world of software engineering as it has more opportunity to be creative and learn new things in the ever-changing world of information technology. I am working to apply my problem-solving skills to create web experiences that are engaging, user friendly, and efficient to run as well as maintain.</p>
