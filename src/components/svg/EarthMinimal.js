...
import '../../styles/EarthMinimal.scss';

export class EarthMinimal extends Component {
	render() {
		return (
			<svg role="presentation" viewBox="0 0 64.2 64.2" className="earth-minimal">
			...
			<path className="earth-minimal__ocean--accent" d="M44.9,60.9c0.2-3.3-0.8-6.7-2.9-9.8c-3.4-5.1-9.2-5.3-15.4-5.6c-4.3-0.2-8.7-0.4-12.7-2.1
			...
			<path className="earth-minimal__ocean--main" d="M56.6,11.5c0.5,0.6-0.5,3.2-0.5,4c-0.1,1.8,0.3,3.6-1.6,4.6c-3.7,2-8,2.4-11.9,3.9c-2.9,1-2.8,3.1-3.8,5.6
