...
import '../../styles/SaturnSmooth.scss';
...
export class SaturnSmooth extends Component {
	render() {
		return (
			...
			<path className="saturn-smooth__ring--accent" d="M80.6,102.7c-45.3,9.3-76.4,5.1-79.2-4.1c-2.5-8.1,13.1-20.5,41.8-33.2c0.2,2.6,0.5,5.3,1,7.9
			...
			<path className="saturn-smooth__ring--main" d="M153.1,30c1.7,2.9,3.3,6,4.6,9.3c11.7-0.7,19.5,0.8,20.6,4.5c2.6,8.5-28.6,25.5-69.7,38.1
