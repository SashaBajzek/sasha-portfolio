...
export class Moon extends Component {
	render() {
		return (
			<div className="hero__tooltipcontainer--moon">
				<span className="hero__image-text--moon">Click for day</span>
				<svg role="presentation" onClick={this.props.changeTimeOfDay} className="hero__image--moon" viewBox="0 0 145 143">
					...
					<path className="moon__st2" d="M51.2,133.8c6.5,2.2,13.5,3.4,20.7,3.4c35.8,0,64.8-29,64.8-64.8c0-18.2-7.5-34.6-19.5-46.3
