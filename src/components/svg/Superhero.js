...
export class Superhero extends Component {
	render() {
		return (
			...
			<path className="superhero__cape-shadow" d="M118.5,65c-0.2-0.3-0.5-0.5-0.7-0.8c-1-1.2-1.9-2.3-2.8-2.8c-1-0.9-1.9-1.4-2.6-1.4c-0.2,0-0.4,0-0.5,0.1
			...
			<path className="superhero__cape-main" d="M118.5,65c-0.2-0.3-0.5-0.5-0.7-0.8c-1-1.2-1.9-2.3-2.8-2.8c-1-0.9-1.9-1.4-2.6-1.4c-0.2,0-0.4,0-0.5,0.1
				c-0.3,0.2-0.4,0.6-0.6,1.3c0,0.2-0.1,0.3-0.1,0.5l0,0.2l-0.2,0c-0.4,0.1-0.8,0.1-1.3,0.1c-1.7,0-3.5-0.5-5.2-0.9
			...
			<path className="superhero__clothing--accent" d="M118.5,65c-0.2-0.3-0.5-0.5-0.7-0.8c-1-1.2-1.9-2.3-2.8-2.8c-1-0.9-1.9-1.4-2.6-1.4c-0.2,0-0.4,0-0.5,0.1
				c-0.3,0.2-0.4,0.6-0.6,1.3c0,0.2-0.1,0.3-0.1,0.5l0,0.2l-0.2,0c-0.4,0.1-0.8,0.1-1.3,0.1c-1.7,0-3.5-0.5-5.2-0.9
			...
			<path className="superhero__boot-shadow" d="M117.8,63.9c-2.3-3-4.7-5-6.1-4.3c-0.6,0.3-0.6,1.1-0.8,2.1c-3.9,0.7-9.3-2.5-12.1-1.4v0
				c-0.1,0.9-0.5,6.9-0.6,8.4c3.4,0.3,7.4,0.4,12.1-0.3c6.9-1,8.9,3.7,10.8,2.5C122.5,70,120.1,66.9,117.8,63.9z"/>
			<path className="superhero__glove" d="M18.3,53.8c-2.5-0.1-6,1.1-8.5,1.4C4.4,52.9-1.8,56.1,0.5,60c1.6,2.6,6.7,0.8,9-0.4c1.6-0.3,5.5,1.7,8.1,1.9
				C17.7,61.3,18.3,53.9,18.3,53.8z"/>
			<path className="superhero__accessory--accent" d="M18,53.6c0,0.2-0.4,7.4-0.5,8.4c0.6,0.1,1.2,0.1,1.7,0.1c0-0.1,0.6-8.2,0.6-8.2C19.3,53.7,18.7,53.7,18,53.6z"
				/>
			<path className="superhero__accessory--accent" d="M96.2,69.2c0-0.2,0.7-7.9,0.8-8.9c0.6,0,1.2,0,1.8,0.1c0,0.1-0.7,8.7-0.7,8.8C97.4,69.2,96.8,69.2,96.2,69.2z"
				/>
			<path className="superhero__boot" d="M118.6,64.6c-2.3-2.7-3.8-5-6-4c-0.6,0.3-0.6,1-0.8,1.9c-4,0.7-10.2-2.2-13.1-1c-0.2,2.2-0.5,6.5-0.6,7.4
				c3.5,0.3,7.4,0.4,12.2-0.3c7-0.9,8.8,3.4,10.7,2.4C122.5,70.1,120.9,67.3,118.6,64.6z"/>
			<path className="superhero__clothing--main" d="M76.6,59.3C76.6,59.2,76.7,59.2,76.6,59.3c-0.6-1-2.3-2.4-6.1-2.4c-2.6,0-5,0.7-5.9,1.4
			...
			<path className="superhero__clothing--accent" d="M52.4,54.4c-2,1.4-4.2,2.6-6.5,3.5c0.8,4.5,3.3,5.8,4.9,7.2c-1.7,0-3.5,0.3-5.2,0.6c-0.3-0.3-2.6-0.1-4,0.4
			...
			<path className="superhero__glove" d="M46.5,72.3c-2.5,0.1-6-1.1-8.5-1.4c-5.4,2.4-11.6-0.9-9.3-4.7c1.6-2.6,6.7-0.8,9,0.4c1.6,0.3,5.5-1.7,8.1-1.9
				C45.8,64.8,46.5,72.2,46.5,72.3z"/>
			<path className="superhero__accessory--accent" d="M46.1,72.8c0-0.2-0.4-7.4-0.4-8.4c0.6-0.1,1.2-0.1,1.7-0.1c0,0.1,0.5,8.2,0.5,8.3
				C47.3,72.7,46.7,72.7,46.1,72.8z"/>
			<path className="superhero__accessory--accent" d="M33,59.6c0.9,0.9,1.8,2,2.5,2.9l0,0c0.3-0.6,0.7-2.1,1.1-3.4C35.4,59.4,34.2,59.5,33,59.6z"/>
			<path className="superhero__accessory--accent" d="M63.9,70c2.5,0.6,16.2,6.7,18.7,4.8c0,0-2.2-10.1,3.6-16.9c-3.9-3.8-20.5-1.4-22.2,0.3v0.1
				C66.1,65.2,64.6,69.3,63.9,70z"/>
			<path className="superhero__nose" d="M35.8,60C25,60,10.8,50.6,7.9,37.9l-0.1-0.3l-0.3,0c-0.1,0-0.2,0-0.3,0c-1.8,0-3.3-1.5-3.3-3.3
			...
			<path className="superhero__skin" d="M64.9,30.3C63.6,16.4,51.2,5.6,36.1,5.6C21,5.6,8.6,16.4,7.3,30.2c-2,0-3.6,1.6-3.6,3.7c0,2,1.6,3.7,3.6,3.7
			...
			<path className="superhero__mouth" d="M36,51.4c-1.9-0.2-3.4-0.9-4.2-1.8c-0.1,0.2-0.1,0.4-0.1,0.6c-0.2,2.1,1.6,4.1,4,4.3c2.4,0.2,4.5-1.3,4.7-3.5
				c0-0.2,0-0.4,0-0.6C39.5,51.1,37.8,51.5,36,51.4z"/>
			<g>
				<path className="superhero__tongue" d="M38,54c0.1-0.8-0.4-1.4-1.1-1.5c-0.5,0-0.9,0.2-1.1,0.6c-0.2-0.4-0.5-0.8-1-0.8c-0.7-0.1-1.3,0.5-1.3,1.3
			...
			<path className="superhero__mask" d="M35.8,37.4c0-4.2,4.1-7.6,9.3-7.6c6.2,0,10.5,3.5,14.3,3.5c5.6,0,5.5,0,5.5,0v2.2c0,3.2-18.3,13.6-29.1,5.3
			...
			<path className="superhero__eye--white" d="M28.2,32.4c-0.6-0.2-1.1-0.3-1.8-0.3c-3,0-5.4,2.4-5.4,5.4c0,1.8,0.8,3.3,2.1,4.3c0.6,0.3,1.4,0.4,2.1,0.4
				c3,0,5.4-2.4,5.4-5.4C30.7,35,29.7,33.4,28.2,32.4z"/>
			<path className="superhero__iris" d="M26,33.1c-0.8,0-1.6,0.2-2.3,0.6c0.4,0.2,0.8,0.6,0.8,1.2c0,0.7-0.6,1.3-1.3,1.3c-0.5,0-0.9-0.3-1.1-0.7
			...
			<path d="M26,33.6c-0.7,0-1.3,0.2-1.8,0.5c0.2,0.2,0.3,0.5,0.3,0.8c0,0.7-0.6,1.3-1.3,1.3c-0.3,0-0.5-0.1-0.7-0.2
			...
			<path className="superhero__eye--white" d="M48.5,32.7c-0.6-0.2-1.1-0.3-1.8-0.3c-3,0-5.4,2.4-5.4,5.4c0,1.8,0.8,3.3,2.1,4.3c0.6,0.3,1.4,0.4,2.1,0.4
				c3,0,5.4-2.4,5.4-5.4C51,35.3,50,33.7,48.5,32.7z"/>
			<path className="superhero__iris" d="M46.2,33.4c-0.8,0-1.6,0.2-2.3,0.6c0.4,0.2,0.8,0.6,0.8,1.2c0,0.7-0.6,1.3-1.3,1.3c-0.5,0-0.9-0.3-1.1-0.7
				...
				"/>
			<path d="M46.2,34c-0.7,0-1.3,0.2-1.8,0.5c0.2,0.2,0.3,0.5,0.3,0.8c0,0.7-0.6,1.3-1.3,1.3c-0.3,0-0.5-0.1-0.7-0.2
			...
			<path className="superhero__hair--accent" d="M85.6,31.6c-0.6-0.5-0.9-1.1-0.9-1.6l0-0.1l0,0c2.3-2.8,3.6-5.7,3.8-8.6c0.3-3.8-1.4-6.5-2.2-7.5
			...
			<path className="superhero__hair--main" d="M85,30.2c7.9-9.8,1.2-16.8,1.2-16.8c-0.4,5.7-1.6,9.2-6.7,9.6c2.1-2.5,2.7-7.7-0.8-10.9l-0.2,0.3
