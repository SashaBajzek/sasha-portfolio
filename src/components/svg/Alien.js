...
export class Alien extends Component {
	render() {
		return (
			...
			<path className="alien__spots" d="M45.3,148.3c0-0.1,0-0.2,0-0.2c0-5,4.6-9,10.2-9c1.9,0,3.8,0.5,5.4,1.4l0.9,0.5v-14l-0.5-0.1
			...
			<path className="alien__body" d="M129.7,78.1c-0.4-0.9-0.9-1.6-1.8-2c-4.8-2,1.6-6.2-2.4-8.1c-2-0.9-3.1,0.9-4.4,2c-2.5,2-6.6-1.7-8.2,1
			...
			<path className="alien__tongue" d="M87,84.9c0-0.5-0.1-0.9-0.1-1.3c-0.5,0.3-1,0.6-1.6,0.9c-0.2,0.1-0.4,0.2-0.6,0.3c-0.4,0.2-0.8,0.4-1.2,0.5
			...
			<path className="alien__teeth" d="M86.9,83.5c-4.2,2.6-10.7,4.3-18,4.2c-7.1,0-13.4-1.7-17.6-4.2c-0.6,7,3.3,13.5,9.8,16.7c0,0,0,0,0.1,0
			...
			<path className="alien__eye--pupil" d="M86.9,83.5c-1.8,1.1-4.1,2.1-6.7,2.8l1.1,3.4l-3.7,0.9l-0.7-3.5c-0.7,0.1-1.4,0.2-2.1,0.3l0.7,3.7l-4.2,0.5
			...
			<path className="alien__eye--whites" d="M113,28.5c-1.8,10.6-11.2,17.8-20.7,16.2c-9.5-1.6-15.8-11.4-14-22.1C80,12.1,89.1,4.7,98.6,6.3
				C108.1,7.9,114.7,17.9,113,28.5z"/>
			<path className="alien__eye--iris" d="M107.1,25c-1.2,0.7-2.6,1-4,0.8c-3.2-0.5-5.4-3.6-4.8-6.8c0.3-1.7,1.2-3,2.5-3.9c-1.1-0.6-2.3-1-3.7-1.2
				c-6.6-1.1-12.7,3.4-13.8,9.9c-1.1,6.6,3.4,12.7,9.9,13.8s12.7-3.4,13.8-9.9C107.1,26.8,107.1,25.8,107.1,25z"/>
			<path className="alien__eye--pupil" d="M103.4,25.9c-0.1,0-0.2,0-0.3,0c-3.2-0.5-5.3-3.5-4.9-6.7c-0.3-0.1-0.7-0.2-1-0.2c-4.1-0.7-7.9,2.1-8.5,6.1
			...
			<path className="alien__eye--whites" d="M60.8,16.1c4.8,9.6,1.3,21-7.3,25.3c-8.6,4.3-19.5,0-24.3-9.6c-4.8-9.6-1.7-20.9,6.9-25.2
				C44.7,2.2,56,6.4,60.8,16.1z"/>
			<path className="alien__eye--iris" d="M53,17.8c-0.5,1.3-1.5,2.4-2.8,3c-2.9,1.5-6.4,0.3-7.9-2.6c-0.8-1.5-0.8-3.2-0.3-4.6c-1.3,0.2-2.5,0.6-3.7,1.2
				c-5.9,3-8.4,10.2-5.4,16.1c3,5.9,10.2,8.4,16.1,5.4s8.4-10.2,5.4-16.1C54.1,19.2,53.6,18.5,53,17.8z"/>
			<path className="alien__eye--pupil" d="M50.6,20.7c-0.1,0.1-0.2,0.1-0.3,0.2c-2.9,1.4-6.4,0.3-7.8-2.6c-0.3,0.1-0.7,0.2-1,0.4c-3.7,1.8-5.2,6.3-3.3,10
