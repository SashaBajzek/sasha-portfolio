  ...
  render() {
    return (
      <svg
        ...
        tabIndex="0"
        viewBox="0 0 220.6 102.6"
        onClick={this.props.takeoffAnimation}
        onKeyPress={this.props.takeoffAnimation}
        className={`hero__image--rocket-alien ${this.props.takeoff}`}
      >
        <path
          className="rocket-alien__fire--accent"
          d="M143.9,41.8c3.9-7.5,12.5-11.4,20.7-11.7c2.1-0.1,4.3-0.2,6.3,0.2c2,0.3,4.2,0.5,6.1,1.3c0.5,0.2,1,0.5,1.5,0.7
        ...
        />
        <path
          className="rocket-alien__fire--main"
          d="M163.2,100.4c1.2,0.4,2.4,0.9,3.6,1.1c0.6,0.1,1.2,0.2,1.7,0.3c0.6,0.1,1.3-0.1,1.9-0.1
        ...
        />
        <path
          className="rocket-alien__rocket--accent"
          d="M165.8,14.6C152.2-1.2,123,1.5,114.9,14.3C108.6,11,101.7,8,94.4,6C82.5,2.8,69,1,55.4,1
        ...
        />
        <path
          className="rocket-alien__rocket--window"
          d="M105.6,73.8c-10.7,0-19.5-1.1-27.9-3.4c-20.1-5.5-41.7-17.3-58-31.7c7.5-16.9,9.4-28.5,9.6-35.3
        ...
        />
        <path
          className="rocket-alien__rocket--main"
          d="M94.4,5.8c-23-6.3-47.7-6-65.5-2.8c-0.2,7.8-2.4,19.5-9.7,35.7c13.8,12.2,35,25.6,58.4,32c19,5.2,37.3,3,52,2.4
        ...
        />
        <path
          className="rocket-alien__spots"
          d="M103.6,65.7c-4-0.1-9.2-0.4-14.6-1.4c0.3-0.7,0.7-1.4,1.3-2l0.2-0.2l-0.2-0.1c-4.7-2.6-8.2-6.8-10.1-11.8
        ...
        />
        <path
          className="rocket-alien__body "
          d="M138.2,53.8c0-0.6-0.3-1.1-0.8-1.5c-2.5-2.1,1.9-3.4-0.1-5.3c-1-1-2.3-0.2-3.3,0.2c-1.9,0.7-3.6-2.3-5.1-1
        ...
        <path
          className="rocket-alien__eye--white"
          d="M114.7,39.9c-1.1,6.6-7.1,11.1-13,10.1c-5.9-1-9.9-7.2-8.7-13.8c1.1-6.6,6.8-11.2,12.8-10.2
				C111.7,27,115.8,33.3,114.7,39.9z"
        />
        <path
          className="rocket-alien__iris"
          d="M111.4,37.5c-0.7,0.4-1.6,0.6-2.5,0.5c-2-0.3-3.4-2.2-3-4.2c0.2-1,0.8-1.9,1.6-2.4c-0.7-0.4-1.5-0.6-2.3-0.8
				c-4.1-0.7-8,2.1-8.7,6.2c-0.7,4.1,2.1,8,6.2,8.7c4.1,0.7,8-2.1,8.7-6.2C111.4,38.7,111.4,38.1,111.4,37.5z"
        />
        <path
          className="rocket-alien__pupil"
          d="M109.1,38.1c-0.1,0-0.1,0-0.2,0c-2-0.3-3.3-2.2-3-4.2c-0.2-0.1-0.4-0.1-0.6-0.2c-2.5-0.4-4.9,1.3-5.4,3.8
				c-0.4,2.5,1.3,4.9,3.8,5.4s4.9-1.3,5.4-3.8C109.1,38.7,109.1,38.4,109.1,38.1z"
        />
        <path
          className="rocket-alien__tongue"
          d="M109.7,53.4c-0.1,0-0.3,0-0.4,0c-0.3,0-0.5,0.1-0.8,0.1c-0.2,0-0.3,0-0.5,0c-0.3,0-0.5,0-0.8,0
        ...
        />
        <path
          className="rocket-alien__teeth"
          d="M110.8,53.2c-3,0.7-7.2,0.4-11.5-1c-4.2-1.4-7.7-3.6-9.7-6c-1.7,4.1-0.6,8.7,2.6,11.8c0,0,0,0,0,0
        ...
        />
        <path
          className="rocket-alien__mouth"
          d="M110.8,53.2c-1.3,0.3-2.9,0.4-4.5,0.4l0,2.2l-2.4-0.2l0.3-2.2c-0.4-0.1-0.9-0.1-1.3-0.2l-0.3,2.4L99.9,55
